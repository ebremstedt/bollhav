...
Connections default to `autocommit=False`: the staging apply
(`apply_atomically_to_target`) runs DELETE/INSERT/MERGE + DROP as one
transaction and commits explicitly, so the per-interval apply stays
atomic. The asset-DDL helpers commit themselves too.
"""
